// pages/api/admin/suppliers/update.js
...
export default async function handler(req, res) {
  try {
    ...
    try {
      const payloads = [
        { supplier_key: key, whatsapp_phone: phone, email_order: email, name: label || data.label || data.name || key },
        { key, phone_whatsapp: phone, email_order: email, label: label || data.label || null },
        { supplier_key: key, whatsapp: phone, email_order: email, name: label || data.label || data.name || key },
      ];
